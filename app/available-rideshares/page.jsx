...
const page = () => {
  ...
  return (
    ...
    Explore a variety of ride requests from our community members who are drivers looking for passengers. Find a match for your route and connect instantly!
        ...
        <div className="prompt_layout grid grid-cols-1 mx-auto w-full" style={{marginBottom: '0px'}}>  {/* Adjusted for better layout handling */}
...
<button
    onClick={() => {
        router.push("/create-prompt"); // Ensure this is the correct path for creating a new ride request
    }}
